...
from seedsigner.models.encode_qr import CompactSeedQrEncoder, CompactShamirShareQrEncoder, GenericStaticQrEncoder, SeedQrEncoder, ShamirShareQREncoder, SpecterXPubQrEncoder, StaticXpubQrEncoder, UrXpubQrEncoder
...
class SeedOptionsView(View):
    ...
    CREATE_SHAMIR_SHARE = "Create Shamir Share"
    SHAMIR_SHARES = "Shamir Shares"
    ...
    def run(self):
        ...
        if self.seed.shamir_share_set_count > 0:
            button_data.append(self.SHAMIR_SHARES)

        button_data.append(self.CREATE_SHAMIR_SHARE)
        ...
        elif button_data[selected_menu_num] == self.SHAMIR_SHARES:
            return Destination(SeedShamirShareListView, view_args={"seed_num": self.seed_num})

        elif button_data[selected_menu_num] == self.CREATE_SHAMIR_SHARE:
            #print(self.seed.generate_shares(k=2, n=3, slip39_passphrase="hóla"))
            return Destination(SeedEntryShamirThresholdView, view_args={"seed_num": self.seed_num})
